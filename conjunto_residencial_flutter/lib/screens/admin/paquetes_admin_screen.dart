...
class PaquetesAdminScreen extends StatefulWidget {
  const PaquetesAdminScreen({super.key});

  @override
  State<PaquetesAdminScreen> createState() => _PaquetesAdminScreenState();
}

class _PaquetesAdminScreenState extends State<PaquetesAdminScreen> {
          ...
          : ListView.separated(
              ...
              itemBuilder: (_, i) {
                ...
                return CustomCard(
                  child: Row(
                    children: [
                      Icon(Icons.inventory_2, color: p.retirado ? Colors.grey : Colors.blue),
